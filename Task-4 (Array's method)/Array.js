...
// 2.filter
// let mobiles =[
//     {brand: "mi",model:"6pro",price: "12000" },

//     {brand: "oppo",model:"reno",price: "42000" },

//     {brand: "max",model:"2plus",price: "32000" },

//     {brand: "realme",model:"11",price: "22000" },

//     {brand: "mi", model:"11pro",price: "17000" }];
...
// let bike=["honda","hero","suzuki","dream"];
// bike.pop("dream");      
// console.log(bike);

// // 4.shift-(remove element at the start of array)
// let cars=["swift","nexon","scorpio","innova"];
// cars.shift("innova");      
// console.log(cars);
...
// 1.Array.from - (convert a String into an Object)
// let myName=("Vasudeo");
// console.log(myName);
// console.log(Array.from(myName));

// // 2.Array.of -(convert any number of comma in seprated element into an array)
// let stars=Array.of("Salman","Akshay","Hritik","Sidharth","varun",1);
// console.log(stars);
// console.log(" ");

// // 3.Array.isArray-(true returns is an array otherwise it returns false)
// let price=[20,35,68,99,64,345,67,123];
// console.log(price);
